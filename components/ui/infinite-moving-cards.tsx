...
export const InfiniteMovingCards = ({
  ...
  return (
    ...
    >
      ...
      >
      <div className="flex text-black items-center py-4 gap-20 justify-center">
        <div className="flex items-center ml-12 gap-2">
          ...
          <div className="dark:text-black text-lg font-medium">TypeScript</div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="dark:text-black text-lg font-medium">React</div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="dark:text-black text-lg font-medium">Next</div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="dark:text-black text-lg font-medium">JavaScript</div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="dark:text-black text-lg font-medium">Tailwind</div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="dark:text-black text-lg font-medium">GraphQL</div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="dark:text-black text-lg font-medium">Firebase</div>
        </div>
      </div>
      </ul>
    </div>
